            ...
            <div class="col-lg-4">
              ...
              <form action="{{ route('register') }}" method="POST" class="mt-3">
                ...
                <div class="form-group">
                 ...
                 <input id="confirm-password" type="password" class="form-control @error('password_confirmation') is-invalid @enderror" name="password_confirmation" required autocomplete="confirm-password">
...
self.$toasted.show(
          ...
          self.email.email_unavailable = false;
    }else{
      self.$toasted.error(
